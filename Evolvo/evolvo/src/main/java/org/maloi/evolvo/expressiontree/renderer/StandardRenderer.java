...
public class StandardRenderer implements RendererInterface, Runnable
{
   ...
   Vector<ImageConsumer> consumers = new Vector<ImageConsumer>(2);
   Vector<ChangeListener> listeners = new Vector<ChangeListener>(2);
   ...
   void feedConsumers(int[] data)
   {
      ...
      var v = new Vector<ImageConsumer>(consumers);
      var e = v.elements();

      while (e.hasMoreElements())
      {
         var ic = e.nextElement();
   ...
   void fireStateChange()
   {
      ...
      var v = new Vector<ChangeListener>(listeners);
      var e = v.elements();

      while (e.hasMoreElements())
      {
         var cl = e.nextElement();
         cl.stateChanged(ce);
      }
   }
}
