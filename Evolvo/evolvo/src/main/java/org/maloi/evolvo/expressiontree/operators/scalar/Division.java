 ...
 *
 */
public class Division implements OperatorInterface, Serializable
{
   private static final long serialVersionUID = 3088660121825530618L;
   ...
   public void perform(Stack theStack, final double registers[])
   {
      ...
      {
         if (Math.abs(a) != a) // it's either infinity or negative infinity
         {
