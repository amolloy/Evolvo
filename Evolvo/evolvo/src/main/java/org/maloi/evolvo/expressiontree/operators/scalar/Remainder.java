...
public class Remainder implements OperatorInterface, Serializable
{
   private static final long serialVersionUID = -400436674037241379L;

   /** Performs the operation. */
   public void perform(Stack theStack)
   {
      theStack.push(Math.IEEEremainder(theStack.pop(), theStack.pop()));
   }
