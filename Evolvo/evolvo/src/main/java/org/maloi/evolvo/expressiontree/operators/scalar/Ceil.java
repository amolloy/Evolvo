...
public class Ceil implements OperatorInterface, Serializable
{
   private static final long serialVersionUID = 8771933830474789336L;

   /** Performs the operation. */
   public void perform(Stack theStack)
   {
      theStack.push(Math.ceil(theStack.pop()));
   }
