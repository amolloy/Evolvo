...
public class RenderOptionsPanel implements ActionListener
{
   ...
   JComboBox<String> widthUnits;
   JComboBox<String> heightUnits;
   JComboBox<String> resolutionUnitsBox;
   ...
   JComboBox<String> createUnitsComboBox()
   {
      var unitsComboBox = new JComboBox<String>(sizeUnits);
   ...
   JComboBox<String> createResolutionComboBox()
   {
      var resolutionComboBox = new JComboBox<String>(resolutionUnits);
