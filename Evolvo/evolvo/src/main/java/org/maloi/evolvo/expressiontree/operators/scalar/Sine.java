 ...
 */
public class Sine implements OperatorInterface, Serializable
{

   private static final long serialVersionUID = -2761379621124896978L;

   /** Perform the operation. */
   public void perform(Stack theStack)
   {
      theStack.push(Math.sin(theStack.pop()));
   }
