 ...
 */
public class Arcsin implements OperatorInterface, Serializable
{
   private static final long serialVersionUID = 1394297552701696390L;

   /** Perform the operation. */
   public void perform(Stack theStack, final double registers[])
   {
      theStack.push(Math.asin(theStack.pop()));
   }
