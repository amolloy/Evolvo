 ...
 */
public class Xor implements OperatorInterface, Serializable
{
   private static final long serialVersionUID = -6344969070999997052L;

   /** Perform the operation. */
   public void perform(Stack theStack, final double registers[])
   {
      long a, b, c;
      a = Double.doubleToLongBits(theStack.pop());
      b = Double.doubleToLongBits(theStack.pop());

      c = a ^ b;

      theStack.push(Double.longBitsToDouble(c));
   }
